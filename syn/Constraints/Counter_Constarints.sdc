...
set CLOCK_PERIOD 15; ######## check this clock_period
set CLOCK_NAME   clk;
...
set_input_delay  -add_delay -clock vir_clk_i -max 7.75 [get_ports reset_pad] 
set_input_delay  -add_delay -clock vir_clk_i -min 2.25 [get_ports reset_pad] 

#Output port delay
set_output_delay -clock vir_clk_i -max 3.931 [get_ports counter_pad] -add_delay

set_output_delay -clock vir_clk_i -min 2.628 [get_ports counter_pad] -add_delay


#######   LOAD SPECIFIACATIONS   ########

set_load	5	[get_ports	counter_pad]
